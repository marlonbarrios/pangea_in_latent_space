...
2. **Digital Utopians** – From California techno-utopianism to Bauhaus epistemic architectures.
3. **Mythic Cartographies** – Migratory entities like *La Llorona*, *El Nautili* as sonic/embodied archives.
4. **Speculative Ecologies & Hybrid Cognition** – Chatbots for ecological speculation, AI as eco-techno organism.
5. **Systems, Governance & Feedback** – CyberSyn-inspired distributed governance, poetic uses of historical computation.
6. **Embodied Resistance & Cultural Memory** – Practices like *Cumbia Rebajada* and textile-based resistance.
7. **Protocols, Archives & Meta-Infrastructures** – Choreographic code notation, Bauhaus as proto-interface, AI as archival machine.
